...
function getNearbyItems(thePlayer, commandName)
	if exports.integration:isPlayerTrialAdmin(thePlayer) or exports.global:isStaffOnDuty(thePlayer) or exports.global:isPlayerScripter(thePlayer) or exports.integration:isPlayerSupporter(thePlayer) then
