local spoilerPrice = 1200
local hoodPrice = 650
local sideskirtPrice = 150
local roofPrice = 1250
local lightPrice = 50
local wheelPrice = 500
local exhaustPrice = 350
local bullbarPrice = 500
local bumperPrice = 350
vehicle_upgrades = {
