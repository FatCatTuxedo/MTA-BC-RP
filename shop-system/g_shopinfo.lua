...
blackFemales = {304, 298, 10, 11, 12, 13, 40, 41, 63, 64, 69, 91, 139, 148, 190, 195, 207, 215, 218, 219, 243, 256, 304 }
whiteFemales = {12, 31, 38, 39, 40, 41, 53, 54, 55, 56, 64, 77, 85, 87, 88, 89, 90, 91, 92, 93, 129, 130, 131, 138, 140, 145, 150, 151, 152, 157, 172, 178, 192, 193, 194, 196, 197, 198, 199, 201, 205, 211, 214, 216, 224, 225, 226, 231, 232, 233, 237, 243, 246, 251, 257, 263, 298 }
...
g_shops = {
	...
	{ -- 2
		...
		{
			name = "Guns and Ammo",
			{ name = "Glock Pistol", description = "A pistol Glock.", price = 850, itemID = 115, itemValue = 23, license = true },
			{ name = "Glock Magazine", description = "Magazine with 17 bullets, compatible with any 9mm pistol.", price = 65, itemID = 116, itemValue = 23, ammo = 17, license = true },
	...
	{ -- 8
		...
		{
			name = "Electronics",
			{ name = "Ghettoblaster", description = "A black ghettoblaster.", price = 80, itemID = 54 },
			{ name = "Camera", description = "A small black analogue camera.", price = 60, itemID = 115, itemValue = 43 },
			{ name = "Cellphone", description = "A stylish, slim cell phone.", price = 135, itemID = 2 },
			{ name = "Radio", description = "A black radio.", price = 30, itemID = 6 },
			{ name = "Earpiece", description = "An earpiece that can be used with an radio.", price = 35, itemID = 88 },
			{ name = "Watch", description = "Telling the time was never so sexy!", price = 10, itemID = 17 },
			{ name = "MP3 Player", description = "A white, sleek looking MP3 Player. The brand reads EyePod.", price = 47, itemID = 19 },
			{ name = "Chemistry Set", description = "A small chemistry set.", price = 850, itemID = 44 },
			{ name = "Safe", description = "A Safe to store your items in.", price = 45, itemID = 60 },
			--{ name = "GPS", description = "A GPS Satnav for a car.", price = 300, itemID = 67 },
			{ name = "Portable GPS", description = "Personal global positioning device, with recent maps.", price = 60, itemID = 111 },
			{ name = "Macbook pro A1286 Core i7", description = "A top of the range Macbook to view e-mails and browse the internet.", price = 600, itemID = 96 },
			{ name = "Portable TV", description = "A portable TV to watch the TV.", price = 120, itemID = 104 },
			{ name = "Toll Pass", description = "For your car: Automatically charges you when driving through a toll gate.", price = 10, itemID = 118 },
			{ name = "Vehicle Alarm System", description = "Protect your vehicle with an alarm.", price = 75, itemID = 130 },
			{ name = "Flashlight", description = "Lights up the environment.", price = 25, itemID = 145 }, -- Disabled by Adams
		}
	},
	{ -- 9
		name = "Alcohol Store",
	...
	},
	{
		...
		image = "general.png",
		{
			...
			{ name = "Golf Club", description = "For those golf ball problems...", price = 50, itemID = 115, itemValue = 2 },
			{ name = "Baseball Bat", description = "Fancy a game?", price = 20, itemID = 115, itemValue = 5 },
			{ name = "Pool Cue", description = "For bustin' balls.", price = 25, itemID = 115, itemValue = 7 },
		},
		{
			name = 'Masks & Bandanas',
			{ name = "Mask", description = "A ski mask.", price = 8, itemID = 56 },
			...
			{ name = "Black Bandana", description = "A black rag.", price = 5, itemID = 124 },
