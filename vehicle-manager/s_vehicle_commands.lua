...
function reloadVehicleByAdmin(thePlayer, commandName, vehID)
	if exports.integration:isPlayerTrialAdmin( thePlayer ) or exports.integration:isPlayerVCTMember( thePlayer ) then
		local veh = false
...
function togVehReg(admin, command, target, status)
	if (exports.integration:isPlayerTrialAdmin(admin)) or (exports.integration:isPlayerVCTMember( admin )) then
...
function unflipCar(thePlayer, commandName, targetPlayer)
	if exports.integration:isPlayerTrialAdmin(thePlayer) or getElementData(thePlayer, "faction") == 4 or exports.integration:isPlayerSupporter(thePlayer) or exports.integration:isPlayerVCTMember( thePlayer ) then
...
function flipCar(thePlayer, commandName, targetPlayer)
	if exports.integration:isPlayerTrialAdmin(thePlayer) or getElementData(thePlayer,"faction") == 4 or exports.integration:isPlayerSupporter(thePlayer) or exports.integration:isPlayerVCTMember( thePlayer ) then -- SFTR, working on motorbikes etc
		if not targetPlayer or not exports.integration:isPlayerTrialAdmin(thePlayer) then
			if not (isPedInVehicle(thePlayer)) then
...
function sendCar(thePlayer, commandName, id, toPlayer)
	if exports.integration:isPlayerTrialAdmin(thePlayer) or exports.integration:isPlayerSupporter(thePlayer) or exports.integration:isPlayerVCTMember( thePlayer ) then
...
addEvent("vehicle-manager:respawnRT", true)
addEventHandler("vehicle-manager:respawnRT", getRootElement(), respawnGuiVehicle)
	...
	if (exports.integration:isPlayerTrialAdmin(thePlayer)) then
		...
		for k, theVehicle in ipairs(vehicles) do
			...
			if dbid and dbid > 0 then
				if getElementData(theVehicle, "faction") < 1 and getElementData(theVehicle, "owner") < 1 then
					local driver = getVehicleOccupant(theVehicle)
					local pass1 = getVehicleOccupant(theVehicle, 1)
					local pass2 = getVehicleOccupant(theVehicle, 2)
					local pass3 = getVehicleOccupant(theVehicle, 3)
...
function deleteVehicle(thePlayer, commandName, id)
	if exports.integration:isPlayerTrialAdmin(thePlayer) or exports.integration:isPlayerScripter(thePlayer) or exports.integration:isPlayerVCTMember( thePlayer ) then
		local dbid = tonumber(id)
		if not (dbid) then
			outputChatBox("SYNTAX: /" .. commandName .. " [ID]", thePlayer, 255, 194, 14)
		else
