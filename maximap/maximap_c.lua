...
addEventHandler("onResourceStart",getResourceRootElement(),calculateFirstCoordinates)
...
addEventHandler("onResourceStop",getRootElement(),unloadImageOnOwnerResourceStop)
