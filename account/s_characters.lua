...
function spawnCharacter(characterID, remoteAccountID, theAdmin, targetAccountName, location)
        ...
        if characterData then
                ...
                setElementDataEx(client, "firemode", 1, true) -- Default to auto
...
function Characters_onCharacterLogout()
        ...
        setElementDataEx(client, "legitnamechange", 1)
        setPlayerName(client, "OwlUser."..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9))..tostring(math.random(0,9)))
        setElementDataEx(client, "legitnamechange", 0)
