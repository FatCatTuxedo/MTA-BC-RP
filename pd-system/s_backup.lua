...
function startBackup(thePlayer) 
	...
	--if getPedOccupiedVehicle(thePlayer) then
		...
		if (getTeamName(theTeam) == "Los Santos International Airport") then
			factionShortName = "USAF"
		end
		
		if (getTeamName(theTeam) == "San Fierro City Maintenance") then
			factionShortName = "HWAY"
		end
