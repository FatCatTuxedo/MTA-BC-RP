...
local function resetPed()
	local previewPed = getElementData(getLocalPlayer(), "rpp.npc.talking") or nil
...
addEventHandler('clothing:list', resourceRoot,
	function(list_)
		...
		local margin = 30
		local previewPed = getElementData(getLocalPlayer(), "rpp.npc.talking") or nil
		window = guiCreateWindow(screen_width - width - margin+20, screen_height - height-margin, width, height, 'Astro Fashion', false)
