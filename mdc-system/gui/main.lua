...
--[[
	if canSeeWarrants[getElementData(localPlayer, "mdc_org")] then
		...
		if ( #warrants > 0 ) then -- REMOVED WARRANT TO FIX MDC
...
-]]
	...
	for i, oneLane in pairs(impounds) do
		...
		guiGridListSetItemText( mainW.imps_lots_list, row, mainW.imps_lots_list_col_dep, oneLane.impounder == 1 and "BCSO" or oneLane.impounder == 60 and "DoJ" or "RT", false, false )
