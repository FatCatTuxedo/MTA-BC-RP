						...
						if (getDistanceBetweenPoints3D(x, y, z, tx, ty, tz)>3) then -- Are they standing next to each other?
							...
							if (foundkit) then
								...
								if money + bankmoney < price then
									...
									exports.global:giveMoney( getTeamFromName(""Bone County Emergency Services""), math.ceil((1-tax)*price) )
									exports.global:giveMoney( getTeamFromName("Fort Carson Municipal Government"), math.ceil(tax*price) )
