...
function issuelicenseGUI()
	...
	addEventHandler("onClientGUIClick", issue.button[1], function ()
		...
		if licensetype == "Tier 2" then
			if exports.factions:isPlayerFactionLeader(getLocalPlayer(), 1) or exports.factions:isPlayerFactionLeader(getLocalPlayer(), 50) or exports.integration:isPlayerSeniorAdmin(getLocalPlayer()) then
			else
