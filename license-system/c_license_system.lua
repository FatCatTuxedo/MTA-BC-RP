...
setElementDimension(Johnson, 158)
...
setElementDimension(dominick, 158)
...
function showLicenseWindow(npcname)
	triggerServerEvent("onLicenseServer", getLocalPlayer(), npcname)
