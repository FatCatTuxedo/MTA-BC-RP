...
function onLicenseServer(npcname)
	local gender = getElementData(source, "gender")
	if (gender == 0) then
		exports.global:sendLocalText(source, "[English] "..npcname.." says: Hello Sir, do you want to apply for a license?", 255, 255, 255, 10)
	else
		exports.global:sendLocalText(source, "[English] "..npcname.." says: Hello Ma'am, do you want to apply for a license?", 255, 255, 255, 10)
	end
end
