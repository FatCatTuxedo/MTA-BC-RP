...
addEventHandler("onClientVehicleEnter", getRootElement(),
    function(thePlayer, seat)
        if thePlayer == getLocalPlayer() and seat == 0 and not exports.global:hasItem( source, snowTireID ) then
		...
		if exports.global:hasItem( source, snowTireID ) or vType == "Plane" or vType == "Helicopter" or vType == "Boat" or vType == "Train" then
			setGravity( 0.008 )
		end
...
function resetGravity()
	if not getPedOccupiedVehicle( getLocalPlayer() ) or exports.global:hasItem( getPedOccupiedVehicle( localPlayer ) , snowTireID ) then
		setGravity( 0.008 )
	end
end
