...
function pedHandsup(thePlayer)
	...
	if (logged==1) then
		if arg == 2 then
			exports.global:applyAnimation( thePlayer, "SHOP", "SHP_Rob_HandsUp", -1, true, false, false)
		else
...
-- Wash Hands -----------------------------------------------------------------------------------
function pedWashHands(thePlayer)
	local logged = getElementData(thePlayer, "loggedin")
	
	if (logged==1) then
		exports.global:applyAnimation( thePlayer, "INT_HOUSE", "wash_up", -1, false, true, false)
	end
end
addCommandHandler ("wash", pedWashHands, false, false )
...
function aimAnimation(thePlayer)
	...
	if (logged==1) then
		if arg == 2 then
			exports.global:applyAnimation( thePlayer, "ped", "ARRESTgun", -1, true, false, false)
		elseif arg == 3 then
			exports.global:applyAnimation( thePlayer, "SHOP", "SHP_Gun_Aim", -1, true, false, false)
		else
