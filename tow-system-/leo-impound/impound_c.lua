...
--SERVICE PED
local pdImpounder = createPed(288, 40.93359375, 1129.556640625, 19.7421875 )
...
local pdReleasePed = createPed(288, 294.01171875, 182.87109375, 1032.8900146484 )
setPedRotation( pdReleasePed, 150 )
setElementDimension( pdReleasePed, 40)
