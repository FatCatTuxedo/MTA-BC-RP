...
local ped = createPed(240, 359.2939453125, 173.5810546875, 1008.8891601563)
setElementInterior(ped, 3)
setElementDimension(ped, 119)
setElementRotation(ped, 0, 0, 274, "default", true)
...
function showImpoundUI(vehElementsret)
	if not wImpound then
		...
		outputChatBox("Welcome to the Los Santos Impound Lot!")
	end
end
