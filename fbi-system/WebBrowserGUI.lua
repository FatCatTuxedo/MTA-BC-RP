...
function WebBrowserGUI:constructor()
	...
	self.m_Window = GuiWindow(0, 0, sizeX, sizeY, "National Crime Information Center (NCIC)", true)
	exports.global:centerWindow(self.m_Window)
	self.m_Window:setSizable(false)
	self.m_ButtonClose = GuiButton(0.25, 0.9, 0.5, 0.1, "Shutdown", true, self.m_Window)
...
function WebBrowserGUI:Browser_Created()
	...
	self:loadURL("https://projectreality.site/ncic/index.php")
end
