...
function dbLog(logSource, actionID, affected, data)
	...
	exports.mysql:query_free("INSERT INTO `logs` VALUES ('"..timeString.."', '".. exports.mysql:escape_string(tostring(actionStr) or "") .."', '".. exports.mysql:escape_string(tostring(sourceStr) or "").."', '".. exports.mysql:escape_string(tostring(affectedStr) or "").."', '".. exports.mysql:escape_string(tostring(data) or "").."')")
