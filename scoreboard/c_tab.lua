...
drawScoreboard = function ()
	...
	local strPlayerCount = "Players: " .. tostring(#g_players) .. "/250"
	-- Render the server name
	dxDrawText ( serverName .. " - " .. strPlayerCount, left, top, right, bottom,
				 SCOREBOARD_SERVER_NAME_COLOR, 1, "default-bold", "center", "center",
				 true, false, SCOREBOARD_POSTGUI )
