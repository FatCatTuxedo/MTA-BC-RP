...
addEventHandler( "onElementDataChange", getRootElement(),
	function(n)
		if getElementType(source) == "player" and ( n == "admin_level" or n == "duty_admin" or n == "duty_script" or  n == "account:gmlevel" or n == "duty_supporter" ) then
			sortReports(false)
		end
	end
)
...
function maximeReportsReminder()
	for key, value in ipairs(getElementsByType("player")) do
		local level = getElementData( value, "admin_level" ) or 0
		local aod = getElementData( value, "duty_admin" ) or 0
		local sod = getElementData( value, "duty_dev" ) or 0
		local god = getElementData( value, "duty_supporter" ) or false
		if (exports.integration:isPlayerSupporter(value) and god == 1) or (exports.integration:isPlayerScripter(value) and sod == 1) or (exports.integration:isPlayerTrialAdmin(value) and aod == 1) then
