...
function openWeaponCreatorMain(commandName, category)
	if exports.integration:isPlayerAdmin(localPlayer) then
		...
		wWeaponsMain = guiCreateWindow(wWeaponsMain_x,wWeaponsMain_y,560,230,"Admin Weapon Creator v2.0 - QUICK MODE",false)
			...
			lCredit1 = guiCreateLabel(10,28,300,18,"Admin Weapon Creator v2.0",false,wWeaponsMain)
			...
			lCredit2 = guiCreateLabel(240,28,300,18,"© Bone County Roleplay",false,wWeaponsMain)
			...
			boxWeapons =  guiCreateComboBox(100,55,116,21,"None",false,wWeaponsMain)
				...
				guiComboBoxAddItem(boxWeapons, "(24-Deagle) SIG P220")
				guiComboBoxAddItem(boxWeapons, "(23-Silenced) Glock")
				guiComboBoxAddItem(boxWeapons, "(25) Shotgun")
				guiComboBoxAddItem(boxWeapons, "(32) Tec-9")
				guiComboBoxAddItem(boxWeapons, "(28) Uzi")
				guiComboBoxAddItem(boxWeapons, "(29-MP5) AR-15")
