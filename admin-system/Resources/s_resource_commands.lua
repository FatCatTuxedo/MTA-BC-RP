...
function restartSingleResource(thePlayer, commandName, resourceName)
	if (exports["integration"]:isPlayerScripter(thePlayer) or exports["integration"]:isPlayerAdmin(thePlayer)) then
		if not (resourceName) then
			...
			local adminTitle = exports.global:getAdminTitle(thePlayerr)
			if (theResource) then
			...
			if (theResource) then
				if stopResource(theResource) then
					...
					if hiddenAdmin == 0 then
						...
						exports.global:sendMessageToAdmins("AdmScript: " .. tostring(adminTitle) .. " stopped the resource '" .. resourceName .. "'.")
					else
			...
			if (theResource) then
				...
				elseif getResourceState(theResource) == "loaded" then
					...
					if hiddenAdmin == 0 then
						...
						exports.global:sendMessageToAdmins("AdmScript: " .. tostring(adminTitle) .. " started the resource '" .. resourceName .. "'.")
					else
