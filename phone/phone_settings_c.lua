...
function drawSettings(xoffset, yoffset)
    ...
    local smallLine = 14
    yoffset = yoffset + 3
    settingGuis[2] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Phone information: Samsung Galaxy S", false, settingGuis.main)
    guiSetFont(settingGuis[2], "default-small")

    yoffset = yoffset + smallLine
    settingGuis[3] = guiCreateLabel(20+xoffset, 30+yoffset, 190, smallLine, "Carrier: AT&T", false, settingGuis.main)
